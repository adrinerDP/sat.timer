...
$(function () {
  ...
  function getCurrentTimeCode() {
    var date = new Date();
    var currentTimeKey = String(date.getHours()).padStart(2, "0") + String(date.getMinutes()).padStart(2, "0");
  ...
  function playAudio(type, code) {
    var audio = new Audio('/public/media/' + type + '/' + code + '.mp3');
    audio.play();
  }
  ...
  toggler.on('click', function () {
    setInterval(function () {
      var code = getCurrentTimeCode();
      var block = getCurrentBlock(code);
...
__webpack_require__(/*! C:\Users\adrinerDP\OneDrive\바탕 화면\SAT\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\adrinerDP\OneDrive\바탕 화면\SAT\resources\sass\app.scss */"./resources/sass/app.scss");
